...
const Catalog = (props) => {
  ...
  function handleChanges(value) {
    const catalogItems = props.productList.filter(
      (word) => ~word.title.rendered.indexOf(value)
    );
  ...
  function makeItemList(type) {
    let array = [];
    return (array = props.productList.filter((a) => a.acf.type === type));
  }
        ...
        >
          ...
          <div className="catalog-page__filter">
            <div className="catalog-page__filter__items">
              <p
                className={`catalog-page__filter__items__text catalog-page__filter__items__all text ${
                  type === "all" ? "selected" : ""
                }`}
                onClick={() => {
            ...
            <div className="catalog-page__filter__search">
              ...
              <div className="catalog-page__filter__search__dropdown">
                ...
                >
                  {filter}
                  <img src={dropdown} alt="rectangle" className="polygon" />
                </p>
                {isFilterShown && (
                  <div className="catalog-page__filter__search__dropdown__popup">
                    <p
          ...
          <div className="catalog-page__filter__mobile">
            <div className="catalog-page__filter__mobile__filters__wrapper">
              <p
                className="catalog-page__filter__mobile__filters text"
                onClick={() => {
                  setFilterShown(!isFilterShown);
                }}
              >
            ...
            {isFilterShown && (
              <div className="catalog-page__filter__mobile__popup">
            ...
            {isMobileShown && (
              <div className="catalog-page__filter__mobile__search__wrapper">
                <input
                  type="text"
          ...
          <div className="catalog-page__items">
            {productList.map((item) => {
              return (
                <div
                  className="catalog-page__items__item pointer"
                  key={item.id}
                >
                  ...
                  <p className="catalog-page__items__item__text text">
                    {item.title.rendered}
                  </p>
                  <div className="catalog-page__items__item__wrapper">
                    <img
                      ...
                      alt=""
                      className={
                        ~liked.indexOf(item.acf.code) &&
                        `catalog-page__items__item__wrapper__like pointer liked`
                      }
                      onClick={() => {
                        handleItemOnStorage(
                          item.acf.code,
                    ...
                    />
                    <p className="catalog-page__items__item__wrapper__price text">
                      {item.acf.price} Р
                    </p>
                    <img
                      src={basket}
                      alt=""
                      className={
                        ~ordered.indexOf(item.acf.code) &&
                        "catalog-page__items__item__wrapper__basket pointer ordered"
                      }
                      onClick={() => {
                        handleItemOnStorage(
                          item.acf.code,
